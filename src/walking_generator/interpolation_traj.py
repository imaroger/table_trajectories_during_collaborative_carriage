...
class FootInterpolation(object):
    ...
    def __init__(self, genrator=BaseGeneratorTraj(), QPsamplingPeriod=0.3, NbSamplingPreviewed=16, commandPeriod=0.001,
        FeetDistance=0.17, StepHeight=0.05, stepTime=2.4):
